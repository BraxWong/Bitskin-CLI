...
bool HELP_H::Help::showHelp(bool fromHelpPage, std::string command)
{
  ...
  while(true)
  {
    ...
    {
      std::cout << "When -depositZen is entered, users will be able to enter the amount to be deposited to their Bitskins' wallet. A url will be shown and users can enter that url in their browsers to proceed with the payment.\n";
    }
    ...
    {
      std::cout << "When -getLitecoinAddress is entered, users will be given a list of litecoin addresses.\n";
    }
    else if(command == "-getEtheriumAddress -h")
    {
      std::cout << "When -getEtheriumAddress is entered, users will be given a list of Etherium addresses.\n";
    }
    else if(command == "-getBitcoinAddress -h")
    {
      std::cout << "When -getBitcoinAddress is entered, users will be given a list of Bitcoin addresses.\n";
    }
    else if(command == "-useGiftCode -h")
    {
      std::cout << "When -useGiftCode is entered, users will be asked to insert the gift code. If the gift code is valid, users' BItskins wallet fund will be updated.\n";
    }
    else if(command == "-getUsedGiftCodes -h")
    {
      std::cout << "When -getUsedGiftCodes is entered, users will be presented with the number of gift codes they have used, and the list of gift codes they have used.\n";
    }
    else if(command == "-getCards -h")
    {
      std::cout << "when -getCards is entered, users will be presented with a list of credit cards that they have stored within their Bitskins' account.\n";
    }
    else if(command == "-depositCard -h")
    {
      std::cout << "When -depositCard is entered, users will be able to deposit to their Bitskin account using their credit card.\n";
    }
    else if(command == "-withdrawlBitcoin -h")
    {
      std::cout << "When -withdrawlBitcoin is entered, users will be required to enter their bitcoin address, two factor authenticator code, and amount they would like to withdraw.\n";
    }
    else if(command == "-withdrawlLitecoin -h")
    {
      std::cout << "When -withdrawlLitecoin is entered, users will be required to enter their litecoin address, two factor authenticator code, and amount they would like to withdraw.\n";
    }
    else if(command == "-withdrawlEthereum -h")
    {
      std::cout << "When -withdrawlEthereum is entered, users will be required to enter their ethereum address, two factor authenticator code, and amount they would like to withdraw.\n";
    }
    else if(command == "-withdrawlBinance -h")
    {
      std::cout << "When -withdrawlBinance is entered, users will be required to enter their Binance receiver, two factor authenticator code, and amount they would like to withdraw.\n";
    }
    else if(command == "-withdrawlVisa -h")
    {
      std::cout << "When -withdrawlVisa is entered, users will be required to enter their visa credit card id, amount they would like to withdraw, credit card security code, and two factor authenticator code.\n";
    }
    else if(command == "-q")
    {
      break;
